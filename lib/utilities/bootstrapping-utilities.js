...
var getValidChildren = function getValidChildren(children, rtl) {
  // .toArray automatically removes invalid React children
  return rtl ? _react["default"].Children.toArray(children).reverse() : _react["default"].Children.toArray(children);
};
